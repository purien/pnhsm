...
Printf("SCardTransmit\n");
  ...
  len = *pcbRecvLength;
   ...
   {
        ftime(&timebuffer1);
	    len = (int)(*pcbRecvLength);
		 //SEND
		err=-1;
        *pcbRecvLength=(DWORD)len;
        ftime(&timebuffer2);
...
static char  atr[18] = {(char)0x3B,(char)0x07,(char)'R',(char)'A',(char)'C',(char)'S',(char)'0', (char)'0',(char)'0',(char)0};
static char atr2[18] = {(char)0x3B,(char)0x07,(char)'C',(char)'O',(char)'M',(char)'X',(char)'0', (char)'0',(char)'0',(char)0};
