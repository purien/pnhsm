...
gcc -o racs78 ./main.o  ./pcsc2.o ./atr.o ./pcscemulator2.o ./grid.o ./serverk.o ./windowglue.o  ./common2.o  ./reentrant2.o ./server6.o ./i2c.o ./i2cmod.o  -lpthread  -L. -lmssl -lmcrypto -ldl
