...
#gcc -o racs71 ./main.o  ./pcsc.o ./atr.o ./pcscemulator.o ./grid.o ./serverk.o ./windowglue.o  ./common2.o  ./reentrant2.o ./server6.o ./i2c.o ./i2cmod.o -lwinscard.so.1.10  -lpthread  -L. -lmssl -lmcrypto -ldl 
#libwinscard.so.1.10
cp ./racs7 ./../racs7
