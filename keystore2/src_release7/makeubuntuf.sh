...
# in pcscemulator.f UNDEF NOFAKE for PCSC EMULATION
#
rm *.o
rm racs77
#
...
#
#gcc -o racs7  ./main.o  ./pcsc.o ./atr.o ./pcscemulator.o ./grid.o ./serverk.o ./windowglue.o  ./common2.o  ./reentrant2.o ./server6.o ./i2c.o ./i2cmod.o -lpcsclite         -lpthread  -L. -lmssl -lmcrypto -ldl 
gcc -o racs77 ./main.o  ./pcsc.o ./atr.o ./pcscemulator.o ./grid.o ./serverk.o ./windowglue.o  ./common2.o  ./reentrant2.o ./server6.o ./i2c.o ./i2cmod.o -lwinscard.so.1.10  -lpthread  -L. -lmssl -lmcrypto -ldl 
#libwinscard.so.1.10
rm *.o
cp ./racs77 ./../racs77
