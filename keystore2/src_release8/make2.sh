...
# !!! in pcscemulator137.h   #define NOFAKE ...FOR PCSC USE
...
#
#
gcc -o racs2 ./main.o  ./pcsc.o ./atr.o ./pcscemulator.o ./grid137.o ./serverk.o ./windowglue.o  ./common2.o  ./reentrant2.o ./server6.o ./i2c.o ./i2cmod.o -lpcsclite -lpthread -lwiringPi -L. -lmssl -lmcrypto -ldl 
#
cp ./racs2 ./../racs2
rm *.o
